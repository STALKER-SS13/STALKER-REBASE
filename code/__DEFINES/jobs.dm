...
// Stalker13
#define DEPARTMENT_BITFLAG_BANDITS 1 << 10
#define DEPARTMENT_BITFLAG_DUTY 1 << 11
#define DEPARTMENT_BITFLAG_FREEDOM 1 << 12
#define DEPARTMENT_BITFLAG_LONERS 1 << 13
#define DEPARTMENT_BITFLAG_MERCENARIES 1 << 14
#define DEPARTMENT_BITFLAG_MILITARY 1 << 15
#define DEPARTMENT_BITFLAG_MONOLITH 1 << 16
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	// Stalker13
	"BANDITS" = DEPARTMENT_BITFLAG_BANDITS,
	"DUTY" = DEPARTMENT_BITFLAG_DUTY,
	"FREEDOM" = DEPARTMENT_BITFLAG_FREEDOM,
	"LONERS" = DEPARTMENT_BITFLAG_LONERS,
	"MERCENARIES" = DEPARTMENT_BITFLAG_MERCENARIES,
	"MILITARY" = DEPARTMENT_BITFLAG_MILITARY,
	"MONOLITH" = DEPARTMENT_BITFLAG_MONOLITH,
))
