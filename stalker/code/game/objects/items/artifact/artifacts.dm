...
/obj/item/artifact/soul/process(mob/living/user, seconds_per_tick = 2)
	. = ..()
	if(!.)
		return
...
/obj/item/artifact/maminibusi/process(mob/living/user, seconds_per_tick = 2)
	. = ..()
	if(!.)
		return
...
/obj/item/artifact/mica/process(mob/living/user, seconds_per_tick = 2)
	. = ..()
	if(!.)
		return
	if(ishuman(user))
...
/obj/item/artifact/firefly/process(mob/living/user, seconds_per_tick = 2)
	. = ..()
	if(!.)
		return
