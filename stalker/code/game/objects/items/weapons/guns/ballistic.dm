...
/obj/item/gun/ballistic/automatic/pistol/pm   // Макаров
	...
	icon = 'stalker/icons/obj/item/ballistic.dmi'
	icon_state = "pm"
	w_class = 2
	...
	recoil = 0.2
	damagelose = 0.2
	pickup_sound = 'stalker/sound/weapons/draw/pm_draw.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/sip  // Sig-Sauer
	...
	recoil = 0.4
	damagelose = 0.2
	pickup_sound = 'stalker/sound/weapons/draw/sig220_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/pm_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/pm_open.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/fort12  // Фора12
	...
	durability = 50
	damagelose = 0.2
	pickup_sound = 'stalker/sound/weapons/draw/fort_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/pm_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/pm_open.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/usp_match  // USP Match
	...
	durability = 60
	damagelose = 0.25
	pickup_sound = 'stalker/sound/weapons/draw/usp_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/pm_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/pm_open.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/aps/Initialize(mapload)
	. = ..()
...
/obj/item/gun/ballistic/automatic/pistol/pernach/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/sten  // Sten MK II
	...
	damagelose = 0.05
	can_scope = 0
	pickup_sound = 'stalker/sound/weapons/draw/mp5_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/mp5_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/mp5_open.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/sten/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/sterling/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/m3a1  // M3A1 Grease Gun
	...
	can_scope = 0
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/abakan_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/abakan_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/abakan_open.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/m3a1/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/reising/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/m76/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/mp40  // MP-40
	...
	can_scope = 0
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/tpc301_draw.ogg'
...
/obj/item/gun/ballistic/automatic/mp3008/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/pps43/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/bizon/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/kiparis/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/berettam38/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/p90
	...
	icon_state = "p90"
	inhand_icon_state = "arg"
	accepted_magazine_type = /obj/item/ammo_box/magazine/stalker/m57x28p90
	fire_delay = 0.8
	can_suppress = 1
	burst_size = 1
	spread = 15
...
/obj/item/gun/ballistic/automatic/fnfal  // FN FAL
	...
	can_scope = 1
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/ak74_draw.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/fnfal/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/woodfnfal/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/aug // Steyr AUG
	...
	can_scope = 0
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/fnf2000_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/fnf2000_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/fnf2000_open.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/aug/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/vz58 // vz. 58
	...
	damagelose = 0.25
	can_scope = 0
	pickup_sound = 'stalker/sound/weapons/draw/ak74u_draw.ogg'
...
/obj/item/gun/ballistic/automatic/m4/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/abakan  // AN-94
	name = "AN-94"
...
/obj/item/gun/ballistic/automatic/abakan/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/sigsg550/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/gp37  // GP37
	...
	can_scope = 0
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/l85_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/groza_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/groza_open.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/gp37/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
	AddComponent(/datum/component/scope)
...
/obj/item/gun/ballistic/automatic/fnf2000/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)

/obj/item/gun/ballistic/automatic/groza	// Groza OTs-14
	name = "Groza OTs-14"
	...
	can_scope = 0
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/groza_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/groza_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/groza_open.ogg'
	var/rof = 0.1 SECONDS

/obj/item/gun/ballistic/automatic/groza/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
	AddComponent(/datum/component/scope)
...
// MAT-49 //
/obj/item/gun/ballistic/automatic/mat49
	name = "MAT-49"
...
/obj/item/gun/ballistic/automatic/mat49/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/aksu74/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
// SKS //
/obj/item/gun/ballistic/rifle/automatic/sks
	name = "\improper SKS"
...
/obj/item/gun/ballistic/automatic/ak74/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
// AK-74S //
/obj/item/gun/ballistic/automatic/strelok_ak
	name = "\improper fast-firing AK-74S"
...
/obj/item/gun/ballistic/automatic/strelok_ak/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
// Makeshift AK74 //
/obj/item/gun/ballistic/automatic/makeshiftak
	name = "\improper makeshift AK-74"
	desc = "A kalashnakov made of junk parts. Very unreliable."
	icon = 'stalker/icons/obj/item/ballistic.dmi'
	icon_state = "MakeshiftAK74"
	inhand_icon_state = "ak74"
	slot_flags = ITEM_SLOT_BACK//|SLOT_BELT
	force = 15
	accepted_magazine_type = /obj/item/ammo_box/magazine/stalker/m545
...
/obj/item/gun/ballistic/automatic/makeshiftak/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/famas/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/tpc301/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
// L-86 //
/obj/item/gun/ballistic/automatic/il86
	name = "\improper L85"
...
/obj/item/gun/ballistic/automatic/il86/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
	AddComponent(/datum/component/scope)
...
/obj/item/gun/ballistic/automatic/l6_saw/pkm/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
/obj/item/gun/ballistic/automatic/val
	...
	can_scope = TRUE
	weapon_weight = WEAPON_MEDIUM
	pickup_sound = 'stalker/sound/weapons/draw/val_draw.ogg'
	load_sound = 'stalker/sound/weapons/load/val_load.ogg'
	eject_sound = 'stalker/sound/weapons/unload/val_open.ogg'
	show_bolt_icon = FALSE
	var/rof = 0.4 SECONDS

/obj/item/gun/ballistic/automatic/val/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, rof)
...
// Gauss Rifle //
/obj/item/gun/ballistic/automatic/gaussrifle
...
/obj/item/gun/ballistic/automatic/gaussrifle/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/scope)
