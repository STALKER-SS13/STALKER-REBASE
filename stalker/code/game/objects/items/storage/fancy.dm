/obj/item/storage/fancy/cigarettes/cigpack_belomorkanal
	...
	base_icon_state = "belomorkanal"
	spawn_type = /obj/item/cigarette/belomorkanal
...
/obj/item/storage/fancy/cigarettes/cigpack_java
	...
	icon_state = "java"
	base_icon_state = "java"
	spawn_type = /obj/item/cigarette/java
...
/obj/item/storage/fancy/cigarettes/cigpack_newports
	...
	desc = "A pack of cigarettes imported from the west. Seems to smoke just fine!"
	icon_state = "newports"
	base_icon_state = "newports"
	spawn_type = /obj/item/cigarette/newports