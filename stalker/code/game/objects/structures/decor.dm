...
/obj/structure/stalker/brainscorchertower
	...
	icon = 'stalker/icons/objects/structures/brainscorchertower.dmi'
...
/obj/structure/stalker/bigyashik
	...
	icon = 'stalker/icons/objects/structures/yashiki/decorations_64x64.dmi'
	icon_state = "bigyashik 0.0"
	density = 1
	opacity = 1

/obj/structure/stalker/bigyashik/melkiy
	icon = 'stalker/icons/objects/structures/yashiki/decorations_32x64.dmi'
...
/obj/structure/stalker/trubas
	...
	icon = 'stalker/icons/objects/structures/trubas.dmi'
	icon_state = "trubas"
	density = 1
