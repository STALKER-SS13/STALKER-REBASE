SUBSYSTEM_DEF(blowouts)
	...
	var/static/list/ambient_sounds = list(
		'stalker/sound/blowout/blowout_amb_01.ogg',
		'stalker/sound/blowout/blowout_amb_02.ogg',
		'stalker/sound/blowout/blowout_amb_03.ogg',
		'stalker/sound/blowout/blowout_amb_04.ogg',
		'stalker/sound/blowout/blowout_amb_05.ogg',
		'stalker/sound/blowout/blowout_amb_06.ogg',
		'stalker/sound/blowout/blowout_amb_07.ogg',
		'stalker/sound/blowout/blowout_amb_08.ogg',
	)
	var/static/list/rumble_sounds = list(
		'stalker/sound/blowout/blowout_ambient_rumble_01.ogg',
		'stalker/sound/blowout/blowout_ambient_rumble_02.ogg',
		'stalker/sound/blowout/blowout_ambient_rumble_03.ogg',
		'stalker/sound/blowout/blowout_ambient_rumble_04.ogg',
	)
	var/static/list/wave_sounds = list(
		'stalker/sound/blowout/blowout_wave_01.ogg',
		'stalker/sound/blowout/blowout_wave_02.ogg',
		'stalker/sound/blowout/blowout_wave_03.ogg',
	)
	var/static/list/boom_sounds = list(
		'stalker/sound/blowout/blowout_boom_01.ogg',
		'stalker/sound/blowout/blowout_boom_02.ogg',
		'stalker/sound/blowout/blowout_boom_03.ogg',
	)
	var/static/list/lightning_sounds = list(
		'stalker/sound/blowout/blowout_lightning_01.ogg',
		'stalker/sound/blowout/blowout_lightning_02.ogg',
		'stalker/sound/blowout/blowout_lightning_03.ogg',
		'stalker/sound/blowout/blowout_lightning_04.ogg',
		'stalker/sound/blowout/blowout_lightning_05.ogg',
		'stalker/sound/blowout/blowout_flare_01.ogg',
		'stalker/sound/blowout/blowout_flare_02.ogg',
		'stalker/sound/blowout/blowout_flare_03.ogg',
		'stalker/sound/blowout/blowout_flare_04.ogg',
	)
	var/static/list/wind_sounds = list(
		'stalker/sound/blowout/blowout_wind_01.ogg',
		'stalker/sound/blowout/blowout_wind_02.ogg',
...
/datum/controller/subsystem/blowouts/proc/start_blowout()
	...
	send_blowout_sound(sound('stalker/sound/blowout/blowout_begin_02.ogg', channel = CHANNEL_BLOWOUT_IMPACT, volume = 50))
	send_blowout_sound(sound('stalker/sound/blowout/blowout_siren.ogg', channel = CHANNEL_BLOWOUT_SIREN, volume = 60))
...
/datum/controller/subsystem/blowouts/proc/blowout_wave()
	send_blowout_sound(sound('stalker/sound/blowout/blowout_particle_wave.ogg', channel = CHANNEL_BLOWOUT_IMPACT, volume = 70))
...
/datum/controller/subsystem/blowouts/proc/blowout_affect_mobs()
	for(var/mob/living/blowie as anything in blowout_affected_mobs)
		if(HAS_TRAIT(blowie, TRAIT_BLOWOUT_IMMUNE) || (blowie.status_flags & TRAIT_GODMODE))
			continue
		if(ishuman(blowie))
...
/datum/controller/subsystem/blowouts/proc/blowout_refresh()
	send_blowout_sound(sound('stalker/sound/blowout/blowout_impact_02.ogg', channel = CHANNEL_BLOWOUT_IMPACT, volume = 70))
	send_blowout_sound(sound('stalker/sound/blowout/blowout_outro.ogg', channel = CHANNEL_BLOWOUT_SIREN, volume = 70))
